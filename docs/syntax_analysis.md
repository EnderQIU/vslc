...
|C  |             | C -> E    |         | C -> ε  |            |           |           |           |           |             |            |           |           |          |            |            |         |         |         |           |         |         |            |            |          |
|E  |             | E -> bE'  |         |         |            |           |           |           |           |             |            |           |           |          |            |            |         |         |         |           |         |         |            |            |          |
|E' |             | E' -> ε   |         | E' -> ε | E' -> ,bE' | E' -> ε   | E' -> ε   | E' -> ε   | E' -> ε   | E' -> ε     | E' -> ε    | E' -> ε   |           |          |            |            |         |         |         |           |         |         |            |            |          |
|D  |             | D -> F    |         |         |            |           | D -> G    | D -> H    | D -> I    | D -> J      | D -> K     | D -> L    |           |          |            |            |         |         |         |           |         |         |            |            |          |
|F  |             | F -> bcL  |         |         |            |           |           |           |           |             |            |           |           |          |            |            |         |         |         |           |         |         |            |            |          |
|M  |             | M -> VM'  |         |         |            |           |           |           |           |             |            |           | M -> VM'  | M -> VM' |            |            |         |         |         |           |         |         |            |            |          |
|M' |             | M' -> ε   | M' -> ε | M' -> ε | M' -> ε    |           | M' -> ε   | M' -> ε   | M' -> ε   | M' -> ε     | M' -> ε    | M' -> ε   |           |          | M' -> +VM' | M' -> -VM' | M' -> ε | M' -> ε | M' -> ε | M' -> ε   | M' -> ε | M' -> ε |            |            |          |
|V  |             | V -> WV'  |         |         |            |           |           |           |           |             |            |           | V -> WV'  | V -> WV' |            |            |         |         |         |           |         |         |            |            |          |
|V' |             | V' -> ε   | V' -> ε | V' -> ε | V' -> ε    |           | V' -> ε   | V' -> ε   | V' -> ε   | V' -> ε     | V' -> ε    | V' -> ε   |           |          | V' -> ε    | V' -> ε    | V' -> ε | V' -> ε | V' -> ε | V' -> ε   | V' -> ε | V' -> ε | V' -> *WV' | V' -> /WV' |          |
|W  |             | W -> bW'  |         |         |            |           |           |           |           |             |            |           | W -> (M)  | W -> d   |            |            |         |         |         |           |         |         |            |            |          |
|W' |             | W' -> ε   | W' -> ε | W' -> ε | W' -> ε    |           | W' -> ε   | W' -> ε   | W' -> ε   | W' -> ε     | W' -> ε    | W' -> ε   | W' -> (N) |          | W' -> ε    | W' -> ε    | W' -> ε | W' -> ε | W' -> ε | W' -> ε   | W' -> ε | W' -> ε | W' -> ε    | W' -> ε    |          |
|N  |             | N -> O    |         | N -> ε  |            |           |           |           |           |             |            |           | N -> O    | N -> O   |            |            |         |         |         |           |         |         |            |            |          |
|O  |             | O -> MO'  |         |         |            |           |           |           |           |             |            |           | O -> MO'  | O -> MO' |            |            |         |         |         |           |         |         |            |            |          |
|P  |             | P -> QP'  |         |         |            |           |           |           |           |             |            |           | P -> QP'  | P -> QP' |            |            |         |         |         |           |         |         |            |            | P -> QP' |
|P' |             | P' -> ε   | P' -> ε |         | P' -> ,QP' |           | P' -> ε   | P' -> ε   | P' -> ε   | P' -> ε     | P' -> ε    | P' -> ε   |           |          |            |            |         |         | P' -> ε | P' -> ε   | P' -> ε | P' -> ε |            |            |          |
|Q  |             | Q -> M    |         |         |            |           |           |           |           |             |            |           | Q -> M    | Q -> M   |            |            |         |         |         |           |         |         |            |            | Q -> f   |
|R  |             | R -> R'   |         |         |            | R -> R'   | R -> R'   | R -> R'   | R -> R'   | R -> R'     | R -> R'    | R -> R'   |           |          |            |            |         |         |         |           |         |         |            |            |          |
|R' |             | R' -> ε   |         |         |            | R' -> UR' | R' -> ε   | R' -> ε   | R' -> ε   | R' -> ε     | R' -> ε    | R' -> ε   |           |          |            |            |         |         |         |           |         |         |            |            |          |
