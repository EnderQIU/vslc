...
ParsingTable::ParsingTable() {
	...
	TABLE_CELL_MACRO_2(A_, IDENTIFIER, A_, IDENTIFIER, A_);
	TABLE_CELL_MACRO_1(A_, HASHTAG, A_, EPSILON);
	...
	TABLE_CELL_MACRO_3(F, IDENTIFIER, F, IDENTIFIER, ASSIGN, L);
	...
	TABLE_CELL_MACRO_1(M_, HASHTAG, M_, EPSILON);
	...
	TABLE_CELL_MACRO_1(V_, HASHTAG, V_, EPSILON);
	...
	TABLE_CELL_MACRO_1(W_, HASHTAG, W_, EPSILON);
	...
	TABLE_CELL_MACRO_1(P_, HASHTAG, P_, EPSILON);
	...
	TABLE_CELL_MACRO_3(J_, ELSE, J_, ELSE, D, K);
}
